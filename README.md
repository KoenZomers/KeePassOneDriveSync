...
## How to use
Download the **KeePassOneDriveSync-\<version\>.plgx** from [here](../../releases/latest) and place it into your KeePass\Plugins folder. Typically this will be `C:\Program Files\KeePass Password Safe 2\Plugins` or if you're using KeePass Portable, put it in a subfolder called Plugins from where your Keepass.exe is located. If you're not sure about the exact location, in KeePass, go to Tools > Plugins > Open Folder to open the exact folder in which the PLGX needs to be placed.
