...
- When changing the project version, update `version.txt`, `KoenZomers.KeePass.OneDriveSync\Properties\AssemblyInfo.cs`, and add a matching release section to `CHANGELOG.md`.
- Always place each C# class in its own `.cs` file named after the class.
